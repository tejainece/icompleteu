...
abstract class _$JaguarIcuApi implements RequestHandler {
  static const List<RouteBase> routes = const <RouteBase>[
    ...
    const Post(path: '/detailed_diagnostic')
  ];

  Future<ToJsonable> eventNotification(Map<dynamic, dynamic> body);
  ...
  Future<dynamic> getDetailedDiagnostics(Map<dynamic, dynamic> body);
...
//Handler for eventNotification
    ...
    if (match) {
      Response<ToJsonable> rRouteResponse0 = new Response(null);
...
//Handler for getDetailedDiagnostics
    match =
    ...
    if (match) {
      ...
      try {
        ...
        rRouteResponse0.headers
            .set('content-type', 'text/plain; charset=utf-8');
        rRouteResponse0.value = await getDetailedDiagnostics(
          rDecodeJsonMap,
        );
        Response<String> rRouteResponse1 = iEncodeToJson.post(
          rRouteResponse0,
